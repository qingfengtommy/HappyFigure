...
class GoogleProvider(LLMProvider):
    ...
    def __init__(self, config: dict | None = None):
        ...
        try:
            ...
            raise ImportError(
                ...
                "pip install 'happyfigure[google]'"
            )
    ...
    def run_prompt(self, model: str, prompt: str, *, system_prompt: str | None = None,
                   image_base64: str | None = None,
                   few_shot_messages: list[dict] | None = None) -> str:
    ...
    def run_image_prompt(self, model: str, prompt: str, *,
    ...
    def run_prompt_with_tools(self, model: str, prompt: str, *,
                              ...
                              tool_executor=None,
                              max_tool_rounds: int = 5) -> ToolCallResult:
